                ...
                <div class="flex items-center justify-between gap10 flex-wrap">
                    <div class="wg-filter flex-grow">
                        <form class="form-search">
                            <fieldset class="name">
                                <input type="text" placeholder="Search here..." id="search" class="" name="name"
            ...
            $('#search').on('keyup', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.length === 0) {
                            rows = `<tr><td colspan="5" class="text-center">No brand found for "<b>${search}</b>"</td></tr>`;
                        } else {
                            data.forEach((item, index) => {
                                rows += `
                                    <tr>
                                        ...
                                        <td class="pname">
                                            <div class="image">
                                                <img src="{{asset('uploads/brands')}}/${item.image}" alt="${item.name}"
                                                    class="image">
                                            </div>
                                            <div class="name">
                                        ...
                                        <td>
                                            <div class="list-icon-function">
                                                ...
                                                <form action="/admin/brand/${item.id}/delete"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="item text-danger delete">
